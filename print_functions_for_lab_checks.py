...
def check_command_line_arguments(in_arg):
    ...
    """
    if in_arg is None:
        print("* doesn't check command line arguments because 'get_input_args' has not been defined.")
    else:
...
def check_creating_pet_image_labels(results_dic):
    ...
    if results_dic is None:
        print("* doesn't check results dictionary because 'get_pet_labels' has not been defined.")
    else:
...
def check_classifying_images(results_dic):
    ...
    if results_dic is None:
        print("* doesn't check results dictionary because 'classify_images' has not been defined.")
...
def check_classifying_labels_as_dogs(results_dic):
    ...
    if results_dic is None:
        print("* doesn't check results dictionary because 'adjust_results4_isadog' has not been defined.")
...
def check_calculating_results(results_dic, results_stats_dic):
    ...
    if results_stats_dic is None:
        print("* doesn't check results dictionary because 'calculates_results_stats' has not been defined.")
    else:
